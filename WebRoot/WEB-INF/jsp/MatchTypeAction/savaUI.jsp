...
<!--显示表单内容-->
<div id=MainArea>
    <s:form action="matchType_%{id == null ? 'add' : 'edit'}">
        <div class="ItemBlock_Title1"><!-- 信息说明 --><div class="ItemBlock_Title1">
        	<img border="0" width="4" height="7" src="${pageContext.request.contextPath}/style/blue/images/item_point.gif" /> 比赛类型 </div> 
        </div>
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                	...
                	<tr><td>比赛类型</td>
                        <td><s:textfield name="typeName" cssClass="InputStyle" />
                    </tr>
                </table>
            </div>
        </div>	
